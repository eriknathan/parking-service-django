    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_ad', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, max_length=50, null=True, verbose_name='Cor Carro')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('update_ad', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
